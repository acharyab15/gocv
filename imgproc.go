...
// MomentsPoints calculates all of the moments up to the third order of a polygon
// or rasterized shape.
//
// For further details, please see:
// https://docs.opencv.org/master/d3/dc0/group__imgproc__shape.html#ga556a180f43cab22649c23ada36a8a139
//
func MomentsPoints(points []image.Point, binaryImage bool) map[string]float64 {
	cPoints := toCPoints(points)
	r := C.MomentsPoints(cPoints, C.bool(binaryImage))
